...
export default function Signup() {
  ...
  <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
            ...
            {/* Email Signup Form */}
            <form onSubmit={handleEmailSignup} className="space-y-5 font-game text-sharp">
              <div>
                <label htmlFor="displayName" className="block text-sm font-medium font-game text-white mb-2">
                  Display Name
                </label>
                <input
                  id="displayName"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium font-game text-white mb-2">
                  Email Address
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium font-game text-white mb-2">
                  Password
                </label>
                <input
                  id="password"
                  ...
                  onChange={handleInputChange}
                  required
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/10 backdrop-blur-sm border rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 ${
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium font-game text-white mb-2">
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"
            ...
            {/* Footer */}
            <div className="mt-8 text-center font-game text-sharp">
